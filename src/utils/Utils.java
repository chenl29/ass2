...
public class Utils {
	...
	private static String DUMMY = "EMPTY_WORD";
	
	public static String[] stopWordsAsArr = { "", "a", "about", "above", "across", "after", "afterwards", "again", "against", "all", "almost",
	...
	public static void writeToFileInS3(String value, String fileName, AWSCredentials credentials) throws IOException{
		String counterFileName = "counters" + fileName+".txt";
		File file = new File(counterFileName);
		FileWriter w = new FileWriter(file);
		w.write("number of pairs transfered between mapper and reducer in " + fileName+" is: "+ value);
		w.close();
		AmazonS3Client s3Client = new AmazonS3Client(credentials);
		s3Client.putObject(new PutObjectRequest("lifshitz.ass2.bucket", counterFileName , file));
	}
